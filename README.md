...
1. **Tự Động Hóa Logic Hysteresis (Chống nhiễu thiết bị):**
   * Quạt tự động bật khi nhiệt độ $> 35^\circ\text{C}$ hoặc khí gas $> 2000\text{ ppm}$.
   * Quạt chỉ tự động tắt khi môi trường thực sự an toàn (Nhiệt độ $< 32^\circ\text{C}$ và Gas giảm dưới $1200\text{ ppm}$), giúp bảo vệ Relay/Động cơ quạt không bị đóng ngắt liên tục ở ngưỡng biên.
2. **Phát Hiện Biến Thiên Nhiệt Độ Nhanh (Rate of Change):**
   * Nếu nhiệt độ tăng vọt $\ge 3^\circ\text{C}$ trong vòng dưới 10 giây, hệ thống lập tức gửi cảnh báo khẩn cấp vì đây là dấu hiệu của nguồn nhiệt bất thường (có khả năng xảy ra hỏa hoạn).
